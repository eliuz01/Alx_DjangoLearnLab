...
urlpatterns = [
    ...
    path('post_create/', PostCreateView.as_view(), name='post_create.html')
    path('post_update/', PostUpdateView.as_view(), name='post_update.html')
    path('post_delete/', PostDeleteView.as_view(), name='post_delete.html')
]
